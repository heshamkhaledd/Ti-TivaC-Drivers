 ...
 * by clearing bit[0] in this register.
 */
...
/* GPTMTAPR/GPTMTBPR: Timer Prescaler Register
 * Bit[0]~Bit[7] -> Timer A/B Prescaler
 */ 
#define GPTMTAPR        0x038
#define GPTMTBPR        0x03C

/* GPTMTAPMR/GPTMTBPMR: Timer A/B Prescaler Match */
...
typedef enum{
    MODE_32=0, MODE_RTC, MODE_16=100
}TIMER_MODE_1;
